...
use Illuminate\Console\Command; use App\Services\Security\DrmHeartbeatService; use Illuminate\Support\Facades\Cache;
final class AuDrmHeartbeatCheck extends Command {
 ...
 public function handle(DrmHeartbeatService $svc): int {
  $lock=Cache::lock('drm:heartbeat:check', 240);
