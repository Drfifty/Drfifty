...
---
**Wallet Escrow via AU BUSINESS:** `POST /escrow/lock` creates `escrow_clearings` under `AU_BUSINESS` vault; spokes `X-App-Id: AU_DEALS|AU_SERV` settle through core ledger — no local wallet.
